...
from retinaface.anchors import Anchors
from retinaface.utils import RegressionTransform
import retinaface.losses
...
class RetinaFace(nn.Module):
    def __init__(self,backbone,return_layers,anchor_nums=3):
        ...
        self.losslayer = retinaface.losses.LossLayer()
